...
CoopTpCharacter::CoopTpCharacter() {
    GetMesh().SetAnimInstance<CoopTpAnimInstance>();
    ...
    // Overridden per match level in CoopTpGameMode::configurePawnForLevel.
    movement.WalkBounds = 22.0f;
