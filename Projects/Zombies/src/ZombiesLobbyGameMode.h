...
/// Pre-match Lobby. Only one map (Town) -- "Start Match" always travels there.
/// has no map-picker buttons (unlike CoopTp's Courtyard/Rooftops toggle).
class ZombiesLobbyGameMode final : public leon::GameMode {
public:
    [[nodiscard]] const char* Id() const override { return "zombies-lobby"; }
