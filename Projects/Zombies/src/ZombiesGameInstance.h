...
class ZombiesGameInstance final : public leon::GameInstance {
public:
    static constexpr const char* kMainMenuMap = "MainMenu";
    static constexpr const char* kLobbyMap = "Lobby";
    static constexpr const char* kDefaultMatchMap = "Town";
    ...
    /// Dynamic cast helper (pack always installs ZombiesGameInstance in main).
    [[nodiscard]] static ZombiesGameInstance& Get(leon::GameInstance& gameInstance) {
        return static_cast<ZombiesGameInstance&>(gameInstance);
    }
    [[nodiscard]] static const ZombiesGameInstance& Get(const leon::GameInstance& gameInstance) {
        return static_cast<const ZombiesGameInstance&>(gameInstance);
    }
