...
namespace
{
	// Quarter-wave sine (0..64 => 0..90 degrees).
	constexpr float SinQuarter[65] = {
...
float FPS2PlatformMath::Sin256(uint32 Angle256)
{
	const uint32 Angle = Angle256 & 255u;
	const uint32 Index = Angle & 63u;
	switch (Angle >> 6)
	{
		case 0:
			return SinQuarter[Index];
		case 1:
			return SinQuarter[64u - Index];
		case 2:
			return -SinQuarter[Index];
		default:
			return -SinQuarter[64u - Index];
...
float FPS2PlatformMath::Cos256(uint32 Angle256)
{
