...
public:
	...
	void ClampPitch()
	{
		BoomPitchDegrees = std::clamp(BoomPitchDegrees, PitchMin, PitchMax);
	}
	...
	[[nodiscard]] float ProbeArmLength(FPhysScene& PhysScene, const glm::vec3& Target, float YawDegrees,
