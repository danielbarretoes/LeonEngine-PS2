...
bool FGoldenShadowLightSpaceTest::RunTest(const FString& Parameters)
{
	...
	static const FVector ExpectedNdc[16] = {FVector(-0.895780861f, -0.164134532f, 0.159571216f),
		FVector(0.255937338f, 0.630195498f, 0.840126753f), FVector(-0.895780861f, 0.0992912278f, -0.534873188f),
		FVector(0.255937338f, 0.893621266f, 0.14568232f), FVector(-0.255937368f, -0.893621266f, -0.46542871f),
		FVector(0.895780861f, -0.0992912427f, 0.215126842f), FVector(-0.255937368f, -0.630195498f, -1.15987301f),
		FVector(0.895780861f, 0.164134562f, -0.479317546f), FVector(0.874324679f, 0.145988911f, 0.564926267f),
		FVector(0.317936242f, -0.875933409f, -0.73739922f), FVector(0.874324679f, 0.632618546f, 0.177329361f),
		FVector(0.317936242f, -0.389303803f, -1.12499607f), FVector(-0.317936182f, 0.389303774f, 0.875003755f),
		FVector(-0.87432462f, -0.632618546f, -0.427321732f), FVector(-0.317936182f, 0.875933409f, 0.48740685f),
		FVector(-0.87432462f, -0.145988941f, -0.814918637f)};
