...
public:
	...
	[[nodiscard]] bool Start(UGameEngine& InEngine, const char* InPackName, FRegisterModesFunction RegisterModes,
		std::string_view PreferredLevelKey = {}, std::string_view PackRootOverride = {});
	...
	[[nodiscard]] FGameplayRouter& Router()
	{
		return Gameplay;
	}
	[[nodiscard]] const FGameplayRouter& Router() const
	{
		return Gameplay;
	}
	[[nodiscard]] FWorldRuntime& GetWorldRuntime()
	{
		return World;
	}
	[[nodiscard]] const FWorldRuntime& GetWorldRuntime() const
	{
		return World;
	}
	[[nodiscard]] UGameEngine* GetEngine() const
	{
		return Engine;
	}
	[[nodiscard]] const std::string& GetPackName() const
	{
		return PackName;
	}
