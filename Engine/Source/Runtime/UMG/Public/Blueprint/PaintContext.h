...
public:
	...
	void DrawLine(float X0, float Y0, float X1, float Y1, const glm::vec3& Color, float Thickness = 2.0f);
	...
	void DrawText(const std::string& Text, float X, float Y, const glm::vec3& Color, float Scale = HudFontScale,
