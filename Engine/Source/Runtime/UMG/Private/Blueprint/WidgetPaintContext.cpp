...
void FPaintContext::DrawLine(float X0, float Y0, float X1, float Y1, const glm::vec3& Color, float Thickness)
{
...
void FPaintContext::DrawText(
	const std::string& Text, float X, float Y, const glm::vec3& Color, float Scale, ETextJustify Justify)
{
	Overlay.AddScreenText(Text, X, Y, Color, Scale, Justify);
}

void FPaintContext::MeasureText(const std::string& Text, float Scale, float& OutWidth, float& OutHeight) const
{
