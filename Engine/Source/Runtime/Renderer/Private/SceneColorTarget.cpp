...
bool FSceneColorTarget::EnsureSize(int InWidth, int InHeight)
{
	...
	glTexImage2D(
		GL_TEXTURE_2D, 0, GL_DEPTH_COMPONENT24, Width, Height, 0, GL_DEPTH_COMPONENT, GL_UNSIGNED_INT, nullptr);
...
void FSceneColorTarget::End(int FramebufferWidth, int FramebufferHeight, unsigned int RestoreFbo) const
{
