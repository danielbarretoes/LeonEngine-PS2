...
public:
    ...
    [[nodiscard]] const UAnimSequence& GetEmbeddedAnim() const { return EmbeddedAnim; }
    ...
    [[nodiscard]] FMaterial& GetMaterial() { return Material; }
    [[nodiscard]] const FMaterial& GetMaterial() const { return Material; }
    void SetMaterial(FMaterial InMaterial) { Material = std::move(InMaterial); }
