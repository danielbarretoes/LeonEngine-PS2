...
public:
	...
	void AddOnScreenDebugMessage(
		std::string Message, float DisplaySeconds = 2.0f, const glm::vec3& InColor = {1.0f, 0.0f, 0.0f});
	...
	void AddScreenLine(
		float InX0, float InY0, float InX1, float InY1, const glm::vec3& InColor, float InThickness = 2.0f);
	...
	static void MeasureText(const std::string& InText, float InPixelScale, float& OutWidth, float& OutHeight);
