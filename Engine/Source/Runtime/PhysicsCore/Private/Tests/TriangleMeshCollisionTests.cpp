...
bool FSegmentTriangleTest::RunTest(const FString& Parameters)
{
	...
	const FVector V0(-100.0f, 0.0f, -100.0f);
	const FVector V1(100.0f, 0.0f, -100.0f);
	const FVector V2(0.0f, 0.0f, 100.0f);
	float T = 1.0f;
	FVector N = FVector::ZeroVector;
	TestTrue("Hit", SegmentTriangle(FVector(0.0f, 200.0f, 0.0f), FVector(0.0f, -100.0f, 0.0f), V0, V1, V2, T, N));
