...
void WriteMaterialFromGltf(const cgltf_material* Mat, const std::string& InName,
    ...
    (void)SaveLeonMaterialFile(OutPath.generic_string(), "M_" + SanitizeName(InName), M, BaseMap,
                               NormalMap);
